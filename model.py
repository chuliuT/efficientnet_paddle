...
from efficientnet_paddle.utils import (
    round_filters,
    round_repeats,
    drop_connect,
...
if __name__ == '__main__':
    ...
    # EfficientNet_trans_paddle("efficientnet-b8", shape=[1, 3, 672, 672])
    # EfficientNet_trans_paddle("efficientnet-l2", shape=[1, 3, 800, 800])
